<template>
  <head>
    <title dir="rtl">دوره های بانوان منظومه آموزشی و فرهنگی اصلس</title>
    ...
    <div class="w-auto h-auto flex flex-col items-center px-5 lg:px-44 pt-12">
      ...
      >
        ...
        >
          <NuxtLink :to="'articledetail/' + latestarticle.id">
            ...
            >
              دوره آموزش زبان انگلیسی بانوان اطلس
            </h2>
          </NuxtLink>
          ...
          >
            <span class="leading-loose text-gray-600">
              ...
              دارد. در کلاس‌های آموزش زبان انگلیسی بانوان اطلس، مسیر یادگیری
              فرزند شما همراه با بازی‌های جذاب، موسیقی، داستان‌های متنوع و کار
              گروهی و با مطالب آموزشی به‌روز کمبریج خواهد بود. </span
            ><span class="leading-loose text-gray-600">
              این دوره برای بانوان ۷ تا ۱۲ سال طراحی شده‌است و شامل دو بخش
          ...
          <h3 class="text-xs text-black">
            ...
            <span>عمومی بانوان(۷ تا ۱۲ سال)</span>
          </h3>
        ...
        >
          <NuxtLink :to="'articledetail/' + latestarticle.id">
            <h2
              ...
              class="lg:text-3xl duration-200 transition ease-in-out hover:text-blue-600 text-2xl lg:my-0 font-bold text-darkBlue leading-snug text-right"
            >
              آموزش زبان انگلیسی برای بانوان ۷ تا ۱۲ سال؛ فرصت طلایی!
            </h2>
          </NuxtLink>
          ...
          >
            <span class="leading-loose text-gray-600"
              ...
              و موسسات معتبر دنیا نشان می‌دهد که یادگیری زبان انگلیسی بانوان
            ...
            ><span class="leading-loose text-gray-600">
              ...
              می‌برد تا همیشه کیفیت آموزش زبان انگلیسی بانوان را حفظ کند.</span
            >
          </h3>
          <NuxtLink to="/preSignUp">
            <button
      ...
      >
        ...
        >
          ...
          >
            <span> شهریه کلاس زبان اطلس بانوان </span>
          </h2>
          <PhArticle size="39" />
        </div>
