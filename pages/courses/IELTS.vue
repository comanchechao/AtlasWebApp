<template>
  <head>
    <title dir="rtl">دوره های IELTS منظومه آموزشی و فرهنگی اصلس</title>
    ...
    <div class="w-auto h-auto flex flex-col items-center px-5 lg:px-44 pt-12">
      ...
      >
        ...
        >
          <NuxtLink :to="'articledetail/' + latestarticle.id">
            ...
            >
              دوره آموزش زبان انگلیسی IELTS اطلس
            </h2>
          </NuxtLink>
          ...
          >
            <span class="leading-loose text-gray-600">
              ...
              دارد. در کلاس‌های آموزش زبان انگلیسی IELTS اطلس، مسیر یادگیری
              فرزند شما همراه با بازی‌های جذاب، موسیقی، داستان‌های متنوع و کار
              گروهی و با مطالب آموزشی به‌روز کمبریج خواهد بود. </span
            ><span class="leading-loose text-gray-600">
              این دوره برای IELTS ۷ تا ۱۲ سال طراحی شده‌است و شامل دو بخش
          ...
          <h3 class="text-xs text-black">
            ...
            <span>عمومی IELTS(۷ تا ۱۲ سال)</span>
          </h3>
        ...
        >
          <NuxtLink :to="'articledetail/' + latestarticle.id">
            <h2
              ...
              class="lg:text-3xl duration-200 transition ease-in-out hover:text-blue-600 text-2xl lg:my-0 font-bold text-darkBlue leading-snug text-right"
            >
              آموزش زبان انگلیسی برای IELTS ۷ تا ۱۲ سال؛ فرصت طلایی!
            </h2>
          </NuxtLink>
          ...
          >
            <span class="leading-loose text-gray-600"
              ...
              و موسسات معتبر دنیا نشان می‌دهد که یادگیری زبان انگلیسی IELTS هرچه
            ...
            ><span class="leading-loose text-gray-600">
              ...
              می‌برد تا همیشه کیفیت آموزش زبان انگلیسی IELTS را حفظ کند.</span
            >
          </h3>
          <NuxtLink to="/preSignUp">
            <button
      ...
      >
        ...
        >
          ...
          >
            <span> شهریه کلاس زبان اطلس IELTS </span>
          </h2>
          <PhArticle size="39" />
        </div>
