<template>
  <div class="h-full w-screen bg-mainWhite">
    ...
    <div class="w-full h-auto justify-center flex-col flex items-center">
      ...
      <div class="flex items-center justify-around w-full h-full p-10">
        <img
        ...
        <div class="flex flex-col items-center space-y-7">
          <h2 class="text-lg">به</h2>
          <h1 class="text-5xl font-bold text-mainBlue">
            موسسه آموزشی و فرهنگی اصلس
          </h1>
          <h2 class="text-lg">خوش اومدید</h2>
          <button
